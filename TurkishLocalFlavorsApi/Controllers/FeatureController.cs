...
namespace TurkishLocalFlavorsApi.Controllers
{
    ...
    {
        private readonly IFeatureService _sliderService;
        private readonly IMapper _mapper;

        public FeatureController(IFeatureService sliderService, IMapper mapper)
        {
        ...
        [HttpPost]
        public IActionResult CreateSlider(CreateFeatureDto createSliderDto)
        {
            _sliderService.TAdd(new Feature()
            {
        ...
        {
            _sliderService.TUpdate(new Feature()
            {
                ...
                FeatureID = updateSliderDto.FeatureID
            });
